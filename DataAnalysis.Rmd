...
kable(summarize(group_by(MData,Group),Mean.Width=mean(Width.All.cm),SD.Width=sd(Width.All.cm),Mean.Length=mean(Length.All.cm),SD.Length=sd(Length.All.cm),Mean.Volume=mean(Volume),SD.Volume=sd(Volume)),caption="Table 1: Table of summary statistics.",padding=10L)
```
